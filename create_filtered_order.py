...
def create_filtered_order():
    """Создаем порядок для отфильтрованных ботов"""
    ...
    conn.close()
    print(f"\nFILTERED ORDER CREATION COMPLETE!")

if __name__ == "__main__":
    create_filtered_order()
