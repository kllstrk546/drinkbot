...
def test_complete_user_journey():
    ...
    try:
        ...
        if updated_profile:
            print(f"   ✅ Updated name: {updated_profile.get('name')}")
            print(f"   ✅ Updated age: {updated_profile.get('age')}")
            print(f"   ✅ Updated city: {updated_profile.get('city')}")
    except Exception as e:
    ...
    try:
        ...
        cursor = conn.cursor()
        cursor.execute("DELETE FROM user_likes WHERE user_id = ? OR liked_profile_id = ?", 
